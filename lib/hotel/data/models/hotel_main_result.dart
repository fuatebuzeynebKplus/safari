class HotelMainResult {
  ...
  factory HotelMainResult.fromJson(Map<String, dynamic> json) {
    return HotelMainResult(
  ...
  factory Result.fromJson(Map<String, dynamic> json) {
    return Result(
      ...
      hotels: json["Hotels"] == null
          ? []
          : List<HotelElement>.from(
              json["Hotels"]!.map((x) => HotelElement.fromJson(x))),
...
class HotelElement {
  ...
  factory HotelElement.fromJson(Map<String, dynamic> json) {
    return HotelElement(
...
class Data {
  ...
  final dynamic roomCombinations;
  ...
  factory Data.fromJson(Map<String, dynamic> json) {
    return Data(
      ...
      roomCombinations: json["RoomCombinations"],
    );
  }

  Map<String, dynamic> toJson() => {
        "Boards": boards.map((x) => x.toJson()).toList(),
        "Providers": providers,
  ...
  factory SearchFilterRoom.fromJson(Map<String, dynamic> json) {
    return SearchFilterRoom(
      ...
      paxes: json["Paxes"] == null
          ? []
          : List<PaxA>.from(json["Paxes"]!.map((x) => PaxA.fromJson(x))),
    );
  }
...
class PaxA {
  ...
  factory PaxA.fromJson(Map<String, dynamic> json) {
    return PaxA(
