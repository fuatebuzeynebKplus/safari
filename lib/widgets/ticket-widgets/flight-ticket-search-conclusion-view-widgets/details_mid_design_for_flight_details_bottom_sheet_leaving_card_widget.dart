...
class DetailsMidDesignForFlightDetailsBottomSheetLeavingCardWidget
    extends StatelessWidget {
  const DetailsMidDesignForFlightDetailsBottomSheetLeavingCardWidget({
    super.key,
    required this.index,
  });
  final int index;
  ...
  Widget build(BuildContext context) {
    ...
    var componyName = results[flightTicketCubit.sendIndexValue!]
        .legs![0]
        .alternativeLegs![0]
        .segments!;
    var operatComponyName = results[flightTicketCubit.sendIndexValue!]
        .legs![0]
        .alternativeLegs![0]
        .segments!;
    var logo = results[flightTicketCubit.sendIndexValue!]
        .legs![0]
        .alternativeLegs![0]
        .segments!;

    String? departureAirportCode = results[flightTicketCubit.sendIndexValue!]
        .legs![0]
        .alternativeLegs![0]
        .segments![index]
        .departureAirport!
    ...
    String? arrivalAirportCode = results[flightTicketCubit.sendIndexValue!]
        .legs![0]
        .alternativeLegs![0]
        .segments![index]
        .arrivalAirport!
        .code;
    String? firstCodeForFlight = results[flightTicketCubit.sendIndexValue!]
        .legs![0]
        .alternativeLegs![0]
        .segments![index]
        .flightNo;
    String? secondeCodeForFlight = results[flightTicketCubit.sendIndexValue!]
        .legs![0]
        .alternativeLegs![0]
        .segments![index]
        .ticketingAirline!
    ...
    String? arrivalAirportCityName = results[flightTicketCubit.sendIndexValue!]
        .legs![0]
        .alternativeLegs![0]
        .segments![index]
        .arrivalAirport!
    ...
    String? departureAirportName = results[flightTicketCubit.sendIndexValue!]
        .legs![0]
        .alternativeLegs![0]
        .segments![index]
        .departureAirport!
    ...
    String? arrivalAirportName = results[flightTicketCubit.sendIndexValue!]
        .legs![0]
        .alternativeLegs![0]
        .segments![index]
        .arrivalAirport!
    ...
    if (index <
        results[flightTicketCubit.sendIndexValue!]
                ...
                .length -
            1) {
      // إذا لم يكن العنصر الحالي هو الأخير، يمكن المقارنة بين المطارين
      isSameAirport = results[flightTicketCubit.sendIndexValue!]
                  .legs![0]
                  .alternativeLegs![0]
                  .segments![index + 1]
                  .departureAirport!
    ...
    var timeData = results[flightTicketCubit.sendIndexValue!]
        ...
        .segments!;
    //--------------------
    dynamic cabinType = results[flightTicketCubit.sendIndexValue!]
        .fares![0]
        .fareAlternativeLegs![0]
        .fareSegments![0]
        .cabinType;
    var flightCabinClassDetails = results[flightTicketCubit.sendIndexValue!]
        .fares![0]
        .fareAlternativeLegs![0]
        .fareSegments;
              ...
              children: [
                ...
                Column(
                  children: [
                    ...
                    // هنا تضع ما تحتاجه عند الفشل في الشرط
                  ],
                ),
                Column(
